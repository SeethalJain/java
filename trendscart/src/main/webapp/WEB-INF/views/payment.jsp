...
body {
	...
	background:url("http://corrupteddevelopment.com/wp-content/uploads/2012/01/popular-payment-icons-e1327652801480.jpg")no-repeat center center fixed;
	margin-top: 20px;
}
 ...
 <div class="container" style="min-height: 700px;">
    <div class="theCard">
      <figure class="theCardFront">
       ...
       <br/>
      <a href="placeOrder"> <div align="center"><input type="button" value="Click To Pay"/></div></a>
   </div>
</div>
</form>
