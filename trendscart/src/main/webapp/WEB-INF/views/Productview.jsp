...
body {
	background:
		url("https://image.freepik.com/free-photo/background-clothes-jeans-color-cotton_1203-6489.jpg")
...
<a href="categoryback"><button type="button" class="button button1" >Back to Categories</button></a>
 ...
 <c:forEach items="${productList}" var="product">
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="D:\trendscart\src\main\WEB_INF\resources\${product.id}.jpg" class="img-responsive" style="height:200px; width:60%"/>
						<div class="caption">
