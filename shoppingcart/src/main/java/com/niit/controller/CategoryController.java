...
public class CategoryController {
	...
	ProductDAO  productdao;
		...
		public String CategoryPage(@RequestParam("categoryid") String categoryid, Model model) {
			System.out.println("inside categorypage ");
			List<Product> list=productdao.getProductListbycategory(categoryid);
			System.out.println("list of products in ctrl-------------------->"+list.toString());
